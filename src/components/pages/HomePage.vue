<template>
    ...
    <div class="container mt-6 m-auto">
        ...
        <p>
            ...
            reprehenderit. Sit maxime veniam dicta doloremque. Reprehenderit
            maxime, nihil porro aperiam commodi nostrum?
        </p>
            ...
            >
                <div>
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5
                                class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-left dark:text-white"
                            >
                                {{ index.title }}
                            </h5>
                        </a>
